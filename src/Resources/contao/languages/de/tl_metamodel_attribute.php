 ...
 *
 * Last-updated: 2020-01-19T13:22:38+01:00
 *
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['country_preset']['0']                 = 'Vorgabe für Land';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['country_preset']['1']                 = 'Hier können Sie eine Vorgabe für eine Sprache hinzufügen.';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['countrymode']['0']                    = 'Ländervorgabe';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['countrymode']['1']                    = 'Hier können Sie das verwendete Land wählen.';
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['second_attr_id']['1']                 = 'Bitte wählen Sie das Attribut für den geografischen Längenwert aus.';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['single_attr_id']['0']                 = 'Attribut';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['single_attr_id']['1']                 = 'Wählen Sie das Attribut aus, in dem die Werte für geografische Länge und Breite gespeichert sind.';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['typeOptions']['geodistance']          = 'Geo-Entfernung';
